        ...
        public void init() {
                ...
                System.out
                                .println("🔧 JwtAuthenticationFilter: "
                                                + (jwtAuthenticationFilter != null ? "INYECTADO ✅" : "NULL ❌"));
        }
                ...
                return http
                                ...
                                .authorizeHttpRequests(authz -> authz
                                                ...
                                                .requestMatchers(
                                                                ...
                                                                // Actuator para monitoreo (considerar restringir en
                                                                // producción)
                                                                "/actuator/**",
                                                                ...
                                                                "/api/institutions/**", // Lista de instituciones para
                                                                                        // registro
                                                                "/api/school-grades/**", // Grados académicos
                                                                                         // disponibles
                                                ...
                                                .requestMatchers(
                                                                ...
                                                                "/api/init/**", // Endpoints de inicialización (SOLO
                                                                                // DESARROLLO)
                                                                "/api/debug/**", // Endpoints de debugging (SOLO
                                                                                 // DESARROLLO)
                                                                "/api/student-validation/**", // Validación de
                                                                                              // estudiantes
                                                                "/api/tasks/grades", // Grados para tareas (público)
                                                                "/api/teacher/tasks/grades", // Grados para tareas de
                                                                                             // profesor
                                                                "/api/files/**" // Subida y descarga de archivos
                                                                                // (temporal)
                                                ).permitAll()
                                                ...
                                                // ADMIN y SUPER_ADMIN: Acceso completo al sistema
                                                // Pueden gestionar usuarios, instituciones, configuración global
                                                ...
                                                // Tareas: Accesibles por profesores (crear/editar) y estudiantes
                                                // (resolver)
                                ...
                                .exceptionHandling(exception -> exception
                                                ...
                                                // Manejo personalizado para acceso denegado (usuario autenticado sin
                                                // permisos)
                                ...
                                .headers(headers -> headers
                                                ...
                                                // Prevenir MIME sniffing - fuerza al navegador a respetar el
                                                // Content-Type
                                                ...
                                                // Política de referrer - controla qué información se envía en el header
                                                // Referer
